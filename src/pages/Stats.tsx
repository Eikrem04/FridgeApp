      ...
      <div className="px-5 md:px-8">
        {!hasData ? (
          <EmptyState
            ...
            subtitle="Once you start adding and using items, your stats will show up here."
          />
        ) : (
          <div className="flex flex-col gap-4">
            <Card className="p-5">
              ...
              <div className="grid grid-cols-3 gap-3 text-center">
                <Stat label="Consumed" value={monthStats.consumed} color="text-[var(--color-good)]" />
                <Stat label="Expired" value={monthStats.expired} color="text-[var(--color-bad)]" />
                <Stat label="Added" value={monthStats.added} color="text-[var(--color-accent)]" />
              </div>
            </Card>

            <Card className="flex items-center justify-between p-5">
              <div>
                <p className="text-[14.5px] font-semibold text-[var(--color-ink)]">Food waste this month</p>
                <p className="text-[13px] text-[var(--color-ink-dim)]">Expired or discarded vs. total used</p>
              </div>
              <span
            ...
            {breakdown.length > 0 && (
              <Card className="p-5">
                <p className="mb-3.5 text-[14.5px] font-semibold text-[var(--color-ink)]">Most added this month</p>
